...
@Mod(StrawberryMinecraft.MODID)
public class StrawberryMinecraft {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "strawberrymc";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "strawberrymc" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "strawberrymc" namespace
    ...
    // Creates a creative tab with the id "strawberrymc:example_tab" for the example item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.strawberrymc")) //The language key for the title of your CreativeModeTab
    ...
    public StrawberryMinecraft(IEventBus modEventBus, ModContainer modContainer) {
